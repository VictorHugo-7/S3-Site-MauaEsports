    ...
    <div className="w-full min-h-screen bg-[#0D1117] flex flex-col items-center">
      ...
      <div className="flex flex-col lg:flex-row w-[90%] sm:w-3/4 lg:w-2/3 gap-6 mb-10">
        ...
        >
          ...
          <div className="sm:hidden border-b border-gray-700 rounded-tr-xl rounded-tl-xl p-4 sticky top-0 bg-gray-800 z-10 font-blinker text-base text-white text-center">
            Lista de Treinos
          </div>
