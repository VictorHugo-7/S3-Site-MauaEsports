...
const Card = ({
  ...
  const shouldShowPerformance =
    columnId !== "inscricoes" && (teamPosition || performanceDescription);
  const shouldShowRegistrationButton =
    columnId !== "passados" && registrationLink;
  ...
  return (
    ...
    >
      ...
      <div className="relative border-b border-gray-700">
        ...
        {gameIconUrl && (
          <div className="absolute top-3 left-4 -translate-y-1/3 z-10 h-12 w-12">
            <img
              src={gameIconUrl}
              alt="Game Icon"
              className="w-14 h-16 object-contain rounded-md bg-gray-900/50 border-2 border-gray-700 shadow-md p-1"
              onError={(e) => {
                e.target.onerror = null;
        ...
        <h3 className="absolute bottom-3 left-3 font-bold text-xl text-white">
          {name}
        </h3>
      </div>
      ...
      <div className="p-4 flex-grow border-b border-gray-700 space-y-4">
        ...
        <div className="space-y-3">
          ...
          {startDate && (
            <div className="flex items-center">
              <svg
                className="w-5 h-5 mr-2 flex-shrink-0 text-blue-400"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
          ...
          {description && (
            <div className="flex items-center">
              <svg
                className="w-5 h-5 mr-2 text-purple-400 mt-0.5 flex-shrink-0"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
          ...
          {(firstPrize || secondPrize || thirdPrize) && (
            <div className="mt-2 space-y-2">
              <h4 className="font-semibold text-gray-200 text-sm uppercase tracking-wider">
                Premiação
              </h4>
                ...
                {firstPrize && (
                  <div className="flex items-center bg-yellow-900/20 rounded px-3 py-1.5">
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M9.668 2.117a1 1 0 011.664 0l2.51 4.124 5.005 1.065a1 1 0 01.538 1.653l-3.54 3.674.649 5.124a1 1 0 01-1.414 1.025L10 16.596l-4.58 2.186a1 1 0 01-1.415-1.025l.648-5.124-3.54-3.674a1 1 0 01.537-1.653l5.005-1.065 2.51-4.124z"
                        clipRule="evenodd"
                      ></path>
                    </svg>
        ...
        {shouldShowPerformance && (
          <div className="mt-4 pt-3 border-t border-gray-700">
            <h4 className="font-semibold mb-2 text-blue-400 text-sm uppercase tracking-wider">
              ...
              {performanceDescription && (
                <div className="bg-gray-800/30 rounded-md p-3">
                  <div className="flex items-start">
                    <svg
                      className="w-4 h-4 mr-2 text-blue-400 mt-0.5 flex-shrink-0"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path
