...
const Apresentacao = () => {
    ...
    return (
        <Margin horizontal="60px">
            ...
            <div data-aos="fade-up" className="bg-fundo flex flex-col lg:flex-row items-stretch lg:items-center justify-between">
                ...
                <div className="w-full lg:w-1/1 space-y-6 text-left lg:pr-8 py-8 lg:py-0">
                    ...
                    <h4 className="text-3xl font-bold mt-2">
                        <span className="text-white block md:inline">{titulo1} </span>
                    ...
                    <div className="flex gap-5">
                        {icones.map(icone => (
                            <a key={icone.id} href={icone.link} target="_blank" rel="noopener noreferrer">
                                <img src={icone.imagem} className="h-10 hover:scale-105 transition-transform duration-600 ease-in-out" alt="Ícone de jogo" />
                            </a>
                        ))}
                    </div>

                    {/* Adm - Botão Editar */}
                    <div className="flex justify-end t-5">
                        <button onClick={abrirModal} className="bg-[#284880] text-white border-0 py-2 px-4 rounded text-sm transition-colors hover:bg-[#162b50] cursor-pointer">
                            Editar
                        </button>
                    </div>
                </div>
                ...
                <div className="w-full lg:w-1/2 flex justify-center lg:justify-end items-center">
                    <img src={imagemUrl} alt="Logo Mauá Esports" className="w-[170px] lg:w-[400px] hover:scale-101 transition-transform duration-300 ease-in-out" />
                </div>
            </div>
